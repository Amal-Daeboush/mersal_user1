...
import 'package:mersal/view/authentication/onboarding/controller/onboarding_controller.dart';
...
import '../../widget/gradiant/custom_gradient_text.dart';
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          SizedBox(width: 219.w, height: 53.w, child: Text(AppTexts.enjoyYourMeal, style: Styles.style2,),),
