...
class MyserviceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: GetBuilder<MyServiceController>(
          init: MyServiceController(id: id, isProductProv: isProductProv),
          builder: (controller) {
            return Stack(
              children: [
                Opacity(
